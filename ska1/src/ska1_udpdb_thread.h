...
#ifndef __SKA1_UDPDB_THREAD_H
#define __SKA1_UDPDB_THREAD_H
...
typedef struct {
  ...
  ska1_sock_t *     sock;               // UDP socket for data capture
...
time_t ska1_dpdb_start (udpdb_t * ctx, char * header);

// main workhorse function to receive data for a single observation
void * ska1_udpdb_receive_obs (void * ctx);
