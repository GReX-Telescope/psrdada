...
$Dada::server_tape_archiver::tapeid_pattern = "HRE[0-9][0-9][0-9]S4";
...
if ($Dada::server_tape_archiver::pid eq "P682") {
  $Dada::server_tape_archiver::tapeid_pattern = "SMC[0-9][0-9][0-9]";
}
