...
?>
  <table class="results" width=100% border=0 cellpadding=5>
    ...
    <tr>
      <td align="center">
        <input type="button" onclick="popWindow('processresult.php?observation=<?echo $data["UTC_START"]?>&action=plot')" value="Create Plots"<?echo $locked?>>&nbsp;&nbsp;&nbsp;
        <input type="button" onclick="popWindow('processresult.php?observation=<?echo $data["UTC_START"]?>&action=reprocess')" value="Reprocess Results"<?echo $locked?>>&nbsp;&nbsp;&nbsp;
        <input type="button" onclick="popWindow('processresult.php?observation=<?echo $data["UTC_START"]?>&action=process_hi')" value="Process Archives"<?echo $locked?>>
      </td>
    </tr>
    <tr>
      <td align="center">
        <input type="button" onclick="popWindow('processresult.php?observation=<?echo $data["UTC_START"]?>&action=annotate')" value="Annotate Obs.">&nbsp;&nbsp;&nbsp;
        <input type="button" onclick="popWindow('processresult.php?observation=<?echo $data["UTC_START"]?>&action=delete_obs')" value="Delete Observation"<?echo $locked?>>
      </td>
    </tr>
  </table>
