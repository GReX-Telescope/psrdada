...
void read_params(char *, int *, float *, float *, float *, int *, float *, int *, int *, char *);
void read_stream(int , char *, float *, long *);
void work_on_data(char *, float *, float *, long, long *, float, float, int, char *, int, int);
void create_xaxis(char *,int,long, long, float, float, float, int, float, float *); 
