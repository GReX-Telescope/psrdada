...
Depending upon the objectives of the experiment, PuMa-II configuration
may change from observation to observation.

\section{Instrumental Configuration}

Based upon the parameters of observation, the {\tt puma2} control
...
The Configuration and Scheduling program, {\tt puma2skd}, will be used
