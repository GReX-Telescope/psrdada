...
int aqdsp_init (aqdsp_hires_t* ctx, dada_hdu_t *in, dada_hdu_t *out, 
                char * bays_file, char * modules_file, char * signal_paths_file);
int aqdsp_destroy (aqdsp_hires_t * ctx, dada_hdu_t * in, dada_hdu_t * out);
