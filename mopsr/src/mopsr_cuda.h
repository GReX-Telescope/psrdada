...
void mopsr_input_transpose_FST_to_FTS (cudaStream_t stream, void * d_in, void * d_out, uint64_t nbytes, unsigned nchan, unsigned nant);
...
void mopsr_tile_beams_transpose (cudaStream_t stream, void * d_in, void * d_fbs, void * d_phasors, uint64_t bytes, unsigned nbeam, unsigned nant, unsigned nchan);
