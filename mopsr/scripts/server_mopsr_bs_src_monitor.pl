...
$Dada::server_sys_monitor::master_log_node_prefix = "bs";
$Dada::server_sys_monitor::master_log_prefix = "bss";
$Dada::server_sys_monitor::log_host = $cfg{"SERVER_HOST"};
$Dada::server_sys_monitor::log_port = $cfg{"SERVER_BS_SRC_LOG_PORT"};
