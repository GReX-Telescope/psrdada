...
$Dada::server_sys_monitor::master_log_node_prefix = "bf";
$Dada::server_sys_monitor::master_log_prefix = "bfs";
$Dada::server_sys_monitor::log_host = $cfg{"SERVER_HOST"};
$Dada::server_sys_monitor::log_port = $cfg{"SERVER_BF_SRC_LOG_PORT"};
