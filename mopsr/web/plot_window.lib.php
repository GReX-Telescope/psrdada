        ...
        if (pw_xml_request.readyState == 4)
        {
          ...
          if (xmlDoc != null)
          {
            ...
            for (i=0; i<ants.length; i++)
            {
              ...
              if ( ant_reason ) {
                document.getElementById(td_name_id).innerHTML = "<a target='_blank' href='" + uri +"'>" + ant_name + "</a><br>" + ant_reason;
              } else {
                document.getElementById(td_name_id).innerHTML = "<a target='_blank' href='" + uri +"'>" + ant_name + "</a><br>";
              }
