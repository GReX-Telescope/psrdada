...
class oldresults extends caspsr_webpage 
{
  ...
  function oldresults()
  {
    ...
    $this->basedir = $this->cfg["SERVER_OLD_RESULTS_DIR"];
  }

  function javaScriptCallback()
  {
    return "oldresults_request();";
  }
...
?>
    ...
    <script type='text/javascript'>
      ...
      function changeLength() {
        ...
        var URL = "oldresults.lib.php?offset="+offset+"&length="+length+"&inlineimages="+show_inline;
      ...
      function oldresults_update_request() 
      {
        var ru_http_requset;
        ...
        var url = "oldresults.lib.php?update=true&offset="+offset+"&length="+length;
          ...
          for (i=0; i<results.length; i++) {
            ...
            for ( key in this_result) {
              ...
              if (key == "SOURCE") {
                ...
                var url = "oldresult.lib.php?utc_start="+utc_start;
                var link = document.getElementById("link_"+i);
                link.href = url;
                link.onmouseover = new Function("Tip(\"<img src='old_results/"+utc_start+"/"+value+"' width=241 height=181>\")");
...
?>
  ...
  ?>
    ...
    <table>
      ...
      <tr><td>White</td><td>Newer oldresults, may still be updated</td></tr>
      <tr><td>Blue</td><td>Finalised oldresults, no new archives received for 5 minutes</td></tr>
    </table>
