...
class hispec_webpage 
{

  /* array of css pages requried */
  var $css = array("/hispec/hispec.css");
  var $ejs = array();
  var $title = "BPSR";
...
function handleDirect($child_class) 
{
  ...
  if (array_key_exists("single", $_GET) && ($_GET["single"] == "true"))
  {
    ...
    echo "    <link rel='shortcut icon' href='/hispec/images/hispec_favico.ico'/>\n";
    ...
    if ($obj->show_logo)
    {
      ...
      echo "  <tr>\n";
      echo "  <td width='210px' height='60px'><img src='/hispec/images/hispec_logo.png' width='200px' height='60px'></td>\n";
