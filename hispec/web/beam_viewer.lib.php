...
class beam_viewer extends hispec_webpage 
{
  ...
  function beam_viewer()
  {
    ...
    $this->title = "HISPEC | Beam Viewer | ".$this->utc_start." ".$this->beam;
...
<?
  for ($i=1;$i<=$this->nbeams; $i++) {
    ...
    if ($i_str != $this->beam) {
      echo "        <td width=40>\n";
      echo "          <div class=\"btns\">\n";
      echo "            <a href=\"/hispec/beam_viewer.lib.php?single=true&utc_start=".$this->utc_start."&beam=".$i_str."\" class=\"btn\" > <span>".$i_str."</span></a>\n";
      echo "          </div>\n";
      echo "        </td>\n";
    } else {
