...
class ganglia_window extends apsr_webpage 
{
  ...
  function ganglia_window()
  {
    ...
    $this->clients_load      = $gang_base."graph.php?g=dada_load_report&z=dada_web&c=APSR%20Clients&m=&r=hour&s=descending&hc=4";
    ...
    $this->srvs_load    = $gang_base."graph.php?g=dada_load_report&z=dada_web&c=APSR%20Servers&h=srv0.apsr.edu.au&m=&r=hour&s=descending&hc=4";
